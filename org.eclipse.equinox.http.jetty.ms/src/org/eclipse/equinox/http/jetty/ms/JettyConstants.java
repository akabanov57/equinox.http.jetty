 ...
 *
 * <p>Contributors: IBM Corporation - initial API and implementation Raymond Augé - bug fixes and
 * enhancements *****************************************************************************
 */
...
final class JettyConstants {
    ...
    /**
     * name="http.nio" type="Boolean" (default: true, with some exceptions for JREs with known NIO
     * problems)
     *
     * @since 1.1
     */
     ...
     * @since 1.3
     */
    @Deprecated static final String MULTIPART_LOCATION = "multipart.location"; // $NON-NLS-1$

    /**
     * @deprecated
     * @since 1.3
     */
    @Deprecated static final String MULTIPART_MAXFILESIZE = "multipart.maxFileSize"; // $NON-NLS-1$
    ...
    static final String CONTEXT_SESSIONINACTIVEINTERVAL =
            "context.sessioninactiveinterval"; //$NON-NLS-1$
     ...
     * (full qualified name of the class that implements <code>
     * org.eclipse.equinox.http.jetty.JettyCustomizer</code> and has a public no-arg constructor;
